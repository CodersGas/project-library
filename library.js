...
saveButton.addEventListener('click', () => {
    ...
    if(isDataValid === false){
        ...
        Book(bookName.value, authorName.value, numPages.value, hasRead.value);
        bookName.value = "";
        authorName.value = "";
        numPages.value = "";
        hasRead.value = "";
...
//create a base table with header
function buildTable(){
...
function addRow(data, keys){
    ...
    //providing unique id to every row of table.
    //it is the id which is generated by firebase for its each data object
...
//remove row visually from table
...
//remove the row's data from the firebase's database
...
//writing data to firebase's database directly 
function writeToDatabase(libraryData){
    //initializing database
    var database = firebase.database();
    //creating a reference object of books in firebase
    ...
    //pushing the data object.
    //push() appends the data to database
    //while set() delets previous data and create newly passed data
    ref.push(data);
}

//retrieving the data from database now...
...
function gotData(data){
    ...
    //returns all the keys as an array from books online database
    var keys = Object.keys(books);

    //saving retrieved data to an array
    ...
    //adding retrieved data to the row of table
